...
getgenv().Caminho1 = TweenService:Create(Part, TweenInfo.new(3), {CFrame = CFrame.new(248.964127, 47.9999924, 72.9024277)})
...
getgenv().Caminho5 = TweenService:Create(Part, TweenInfo.new(3), {CFrame = CFrame.new(715.029358, 46.4738922, 1457.61072)})
...
getgenv().Fita1 = TweenService:Create(Part, TweenInfo.new(4), {CFrame = CFrame.new(1102.28711, 46.6738968, 1117.70972)})
